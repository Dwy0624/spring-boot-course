package top.dwy.boot.websocket.controller;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.*;
import top.dwy.boot.websocket.entity.Device;
import top.dwy.boot.websocket.entity.DeviceData;
import top.dwy.boot.websocket.handler.DeviceWebSocketHandler;
import top.dwy.boot.websocket.mapper.DeviceDataMapper;
import top.dwy.boot.websocket.mapper.DeviceMapper;
import top.dwy.boot.websocket.result.Result;
